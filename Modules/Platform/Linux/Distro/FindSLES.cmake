...
if(CAT AND SED)
    if(DEFINED SLES)
        if(EXISTS /etc/os-release)
            if(${OS_RELEASE_DISTRO} MATCHES "SUSE Linux Enterprise Server")
                set(SLES 1)
            else()
                set(SLES 0)
            endif()
        elseif(EXISTS /etc/SUSE-release)
            ...
            string(FIND ${DISTRO_RELEASE_DISTRO} "SUSE Linux Enterprise Server" SLES_POSITION)
            if(${SLES_POSITION} GREATER -1)
                set(SLES 1)
            else()
                set(SLES 0)
            endif()
        else()
            if(${LSB_RELEASE_DISTRO} MATCHES "SUSELinuxEnterpriseServer")
                set(SLES 1)
            else()
                set(SLES 0)
            endif()
